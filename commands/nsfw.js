module.exports = {
    ...
    run: async (call) => {
        ...
        try {
            ...
            if (!call.args[0]) return message.reply("List of all NSFW tag : \n" + `${call.bot.config.prefix}NSFW ` + "`bj, anal, pussy, ass, boobs, cum, futa, ero, yuri, neko, lesbian`")

            //if (call.args[0] == "neko") {

            if (!call.args[0]) {
                return nsfw("randomhentaigif")
            }
            ...
            else if (call.args[0] == "boobs") return nsfw("boobs")
